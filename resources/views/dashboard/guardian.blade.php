...
@section('content')
    <!-- Hero Section -->
    <div class="relative bg-blue-500 overflow-hidden">
        <!-- Optional: Background Pattern/Blob -->
        <div class="absolute inset-0 z-0">
             <div class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-blue-400 opacity-20 filter blur-3xl"></div>
             <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-indigo-500 opacity-20 filter blur-3xl"></div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            ...
            <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-12 font-light leading-relaxed">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-6">
                <a href="{{ route('bookings.create') }}" class="inline-flex items-center justify-center px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all text-lg min-w-[200px]">
                    Book a Helper
                </a>
            </div>
        </div>
    ...
    <div class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div class="bg-gradient-to-r from-orange-400 to-orange-500 rounded-xl shadow-lg p-6 mb-12 text-white flex flex-col md:flex-row items-center justify-between gap-6 relative z-40 -mt-20 overflow-hidden">
                        ...
                        <div class="grid gap-4">
                            @foreach($activeBookings as $booking)
                                <div class="bg-gray-50 p-4 rounded-lg flex justify-between items-center">
                                    <!-- Short trip summary -->
                                    <span class="font-medium">{{ $booking->beneficiary->name }} with {{ $booking->helper->name }}</span>
            ...
            <div class="text-center mb-12">
                ...
                @else
                    <a href="{{ route('beneficiaries.index') }}" class="inline-block px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition">
                        Add Beneficiary to Book
                    </a>
                @endif
            </div>
